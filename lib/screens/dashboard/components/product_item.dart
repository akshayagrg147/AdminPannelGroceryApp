        ...
        children: [
          ...
          SizedBox(
            ...
            child: DataTable2(
              ...
              rows: List.generate(
                itemData!.length,
                (index) => productItemRow(itemData![index], Cubit, bestCubit,
...
DataRow productItemRow(
  ItemData data,
  DeleteProductCubit cubit,
  BestSellingCheckBoxCubit bestCubit,
  ExclusiveCheckBoxCubit excubit,
  Function(ItemData) editClick,
) {
  ...
  return DataRow(cells: [
    ...
    DataCell(BlocConsumer<DeleteProductCubit, DeleteProductState>(
      listener: (context, state) {
