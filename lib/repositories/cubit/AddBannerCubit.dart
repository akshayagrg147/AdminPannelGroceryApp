...
class AddBannerCubit extends Cubit<AddBannerCategoryState> {
  ...
  void addBannerCategory(List<SubBannerCategoryList> list,String banner1,String bannerImage1,String banner2,String bannerImage2,String banner3,String bannerImage3) async {
    try {
      emit(AddBannerLoadingState());
      AddProductResponse posts = await postRepository.addBannerCategory(banner1,bannerImage1,banner2,bannerImage2,banner3,bannerImage3,list);
